...
export async function buildDistribution(
  ...
  files["package/README.md"] =
    "# Murmur\n\nRun `murmur setup --user` to configure Codex and Claude Code. Connect an MCP client to `murmur-mcp` and call `get_setup_guide` for complete setup, hooks, and feature instructions. Requires Bun 1.3.11 or newer.\n\nThis package contains executable bundles; the source repository remains private. See LICENSE and THIRD_PARTY_NOTICES.txt.\n";
