...
export function migrateSqliteClientNames(database: Database): void {
  database.exec(`
    CREATE TABLE broadcasts_v12 (
      ...
      client_name TEXT NOT NULL CHECK(client_name IN ('claude', 'codex', 'connector')),
    ...
    CREATE TABLE messages_v12 (
      ...
      client_name TEXT
        CHECK(client_name IS NULL OR client_name IN ('claude', 'codex', 'connector')),
      idempotency_key TEXT,
      created_at TEXT NOT NULL,
      expires_at TEXT NOT NULL,
      read_at TEXT,
    ...
    CREATE TABLE feedback_submissions_v12 (
    ...
    INSERT INTO feedback_submissions_v12(
    ...
    ALTER TABLE broadcasts_v12 RENAME TO broadcasts;
    ALTER TABLE messages_v12 RENAME TO messages;
    ALTER TABLE feedback_submissions_v12 RENAME TO feedback_submissions;
