      ...
      return new Response(
        request.method === "HEAD"
          ...
          : [
              ...
              "OpenCode, Cursor, Pi, and Oh My Pi can begin through any standard Streamable HTTP MCP entry at the same setup URL.",
              ...
              "With your credential in MURMUR_API_TOKEN, run murmur setup --user for Claude Code, Codex, fx, OpenCode, Cursor, Pi, and Oh My Pi, then restart your agent host.",
