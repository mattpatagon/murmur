...
These self-hosted brand assets were retrieved from the named product owners on 2026-09-06.
They are displayed only to identify compatible agent harnesses and remain the property of their
respective owners.

| Client | Local asset | SHA-256 | Primary source |
| --- | --- | --- | --- |
